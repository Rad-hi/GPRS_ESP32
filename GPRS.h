...
////APNs (google the apn of your network provider in your country)
/*
 *TunTelecom.tn   ->    "internet.tn" 
 *Orange.tn       ->    "weborange" 
 *Ooredoo.tn      ->    "internet.ooredoo.tn"
 */
#define APN                     "internet.tn" 
#define GPRS_USER               ""
#define GPRS_PASS               ""
...
void setup_modem(){ //this is specified by the datatsheet !
